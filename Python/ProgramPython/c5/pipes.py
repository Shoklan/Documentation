...
# stdout/stdin-- my reads and writes map to output and inpit streams of the
# spawned program; much like os.popen2 plus parent stream reticection;
##############################################################################
...
def spawn(prog, *args):                               # pass progname, cmdline args
   ...
   if pid:
      ...
      os.close(parentStdout)                          # close parnet ends in child
...
if __name__ == '__main__':
   ...
   sys.stdout.flush()                                 # subvert stio buffering
