# Frame base menus; for top-leves and components

from Tkinter import *                                        # get widget classes
from tkMessageBox import *                                    # get standard dialog
...
def makemenu(parent):
   ...
   submenu = Menu(edit, tearoff=0, title='HUEHUEHUE')
   submenu.add_command(label='Spam',  command=parent.quit, underline=0)
   submenu.add_command(label='Eggzz', command=notdone,     underline=0)
...
if __name__ == '__main__':
   ...
   mankemenu(root)                                          # associate a menu bar
